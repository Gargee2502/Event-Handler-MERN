...
function EventCard({ event, isRegistered, isSelected, onOpen, style }) {
  ...
  return (
    <div
      className={`ecard ${isSelected ? "ecard--selected" : ""}`}
      style={style}
      onClick={onOpen}
    >
      ...
      <div className="ecard__banner" style={{ background: cfg.bg }}>
        {event.eventImage
          ? <img src={event.eventImage} alt={event.eventName} className="ecard__img" />
