// frontend/src/components/Admin/DeleteModal.js
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '0.75rem', color: '#7a7a8c', marginBottom: '16px' }}>
            Are you sure you want to delete <strong>"{eventName}"</strong>? This will move it to your history.
          </p>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button 
              onClick={onClose} 
              style={{ flex: 1, padding: '10px', borderRadius: '10px', border: '1.5px solid #ece8fc', background: 'white', cursor: 'pointer', fontSize: '0.8rem' }}
            >
              Cancel
            </button>
            {/* The "Yes, Delete" button now calls onConfirm from AdminHome */}
            <button 
              onClick={onConfirm} 
              style={{ flex: 1, padding: '10px', borderRadius: '10px', border: 'none', background: '#e8615a', color: 'white', fontWeight: '700', cursor: 'pointer', fontSize: '0.8rem' }}
            >
              Yes, Delete
            </button>
          </div>
